...
(
    ...
    `single_print`     tinyint(1)          DEFAULT '0',
...
VALUES (1, 2, 1, 'ddd', '2021-12-07 10:26:26', '2021-12-07 10:48:10', b'1');
INSERT INTO `tab_message`
VALUES (2, 1, 2, 'fdadf', '2021-12-07 23:21:45', NULL, b'0');
COMMIT;
...
VALUES ('wxa338748af669c502', 'b679fccf897d1c5b25b8e49818d693e0');
COMMIT;
...
VALUES (1, NULL, NULL, 222, 2, 2, 'hh', 'balabala', '2021-12-07 10:52:51', 1);
INSERT INTO `tab_topic`
VALUES (2, 1, NULL, 222, 2, 3, NULL, 'dfadfda', '2021-12-07 22:18:21', 1);
INSERT INTO `tab_topic`
VALUES (3, 2, NULL, 222, 2, 3, NULL, NULL, '2021-12-07 22:33:39', 1);
COMMIT;
...
VALUES (1, '16302010059', NULL, NULL, '$2a$10$nLpdFqP44VT0ZOqPBWNYFe3uXdy0umeX5uuNfsk7B5lmDCbxbBGIm', NULL, NULL, NULL,
        '2021-12-10 18:08:39', NULL, 1, b'1', 0);
INSERT INTO `tab_user`
VALUES (2, NULL, 'doughit', NULL, '$2a$10$nLpdFqP44VT0ZOqPBWNYFe3uXdy0umeX5uuNfsk7B5lmDCbxbBGIm', NULL, NULL, NULL,
        '2021-12-10 18:09:52', '2021-12-10 18:10:26', 0, b'1', 0);
INSERT INTO `tab_user`
VALUES (3, '16302010010', NULL, NULL, '$2a$10$bt3CvXkjEFQrq6tO2oGzlO0AHYBZK/Wvh7cx8BzhrYrzKlaoURI4S', NULL, NULL, NULL,
        '2021-12-13 22:09:13', '2021-12-14 08:26:15', 1, b'1', 0);
COMMIT;
...
delimiter ;;
CREATE TRIGGER `merge_user`
    BEFORE UPDATE
    ON `tab_user`
    FOR EACH ROW if old.student_id is null and new.student_id is not null then
